	...
	return (
		<div className="md:px-[4.0625rem] 2xl:px-24 py-12">
			<div className="flex flex-col md:flex-row mb-12">
				<h1 className="text-center md:text-left text-5xl portrait:text-5xl md:text-6xl font-mono tracking-wide">
					A whole <br />
				...
				<div className="flex flex-col md:ml-auto md:items-center">
					<h2 className="font-mono text-xxl mb-3 text-center portrait:text-center md:text-left px-2 md:px-0 mt-3 md:mt-0">
