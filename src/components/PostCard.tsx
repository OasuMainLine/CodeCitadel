...
import { _formatDate, _getPostURL, _slug } from "../../lib/clientUtils";
...
export default function PostCard({ post }: PostCardProps) {
	...
	return (
		<Link href={_getPostURL(slug)}>
			<motion.div
				whileTap={{ scale: 0.9 }}
				className="flex flex-col w-[20rem] md:w-[45.8125rem] gap-1 postcard portrait:after:border-0"
			>
